...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var great6 = numbers.Where(num => num > 6);
            
            foreach ( var num in great6) { Console.WriteLine(num); }
           ...
           foreach (var num in numbers.Where(num => num > 5))
            {
                Console.WriteLine(num);
            }
            ...
            var overage = employees.Where(x => x.Age > 26).OrderBy(x => x.Age).ThenBy(x => x.FirstName);
            
            foreach ( var item in overage)
            {
            ...
            var sumAndAv = employees.Where(x => x.YearsOfExperience <= 10 && x.Age > 35);
            var sumofYOE = sumAndAv.Sum(x => x.YearsOfExperience);
            var avOfYOE = sumAndAv.Average(x => x.YearsOfExperience);

            Console.WriteLine($"Sum : {sumofYOE} Average : {avOfYOE}");
            Console.WriteLine("-------------------------------------");
